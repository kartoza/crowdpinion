...
then
    ...
    rsync -L  backups/latest.dmp staging.crowdpinion.kartoza.com:/home/web/deployment/backups/
    rsync -r -v media/ staging.crowdpinion.kartoza.com:/home/web/deployment/media
    ...
    ssh staging.crowdpinion.kartoza.com "cd /home/web/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
